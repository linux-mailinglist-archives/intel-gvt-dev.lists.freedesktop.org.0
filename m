...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 76D87732C01
	for <lists+intel-gvt-dev@lfdr.de>; Fri, 16 Jun 2023 11:40:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4651310E58F;
...
Subject: [PATCH v13 06/22] vfio: Pass struct vfio_device_file * to
