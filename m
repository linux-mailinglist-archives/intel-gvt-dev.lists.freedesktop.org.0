...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id AE5BB28FDA9
	for <lists+intel-gvt-dev@lfdr.de>; Fri, 16 Oct 2020 07:41:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3B2316E9AB;
	Fri, 16 Oct 2020 05:41:05 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3AEA46E9AB
 for <intel-gvt-dev@lists.freedesktop.org>;
 Fri, 16 Oct 2020 05:41:04 +0000 (UTC)
IronPort-SDR: /ARyRN+OQG3/9QUATnKv6s2KpIGCbiAy2WKwQQE9PO0N17QtGfmnOsE3rB3BN0uxeWt/Gu6Kje
 sWCe0bw+MP2A==
X-IronPort-AV: E=McAfee;i="6000,8403,9775"; a="154335629"
X-IronPort-AV: E=Sophos;i="5.77,381,1596524400"; d="scan'208";a="154335629"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 15 Oct 2020 22:41:03 -0700
IronPort-SDR: NBlryIj0pTfNBPd2zzZTjuFoK4OvVJXq9TjMwsFkOJgtZUHGBI2EWmfCN2XeYvOOcD63UHATBT
 bxDeNb5kfWwQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,381,1596524400"; d="scan'208";a="314784764"
Received: from unknown (HELO coxu-arch-shz.sh.intel.com) ([10.239.160.24])
 by orsmga003.jf.intel.com with ESMTP; 15 Oct 2020 22:41:02 -0700
From: Colin Xu <colin.xu@intel.com>
To: intel-gvt-dev@lists.freedesktop.org
Subject: [PATCH v2] drm/i915/gvt: Only pin/unpin intel_context along with
 workload
Date: Fri, 16 Oct 2020 13:40:59 +0800
Message-Id: <20201016054059.238371-1-colin.xu@intel.com>
