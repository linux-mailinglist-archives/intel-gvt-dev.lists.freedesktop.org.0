...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E61639934D
	for <lists+intel-gvt-dev@lfdr.de>; Wed,  2 Jun 2021 21:12:23 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3BF106EE19;
...
Subject: [PATCH v2 4/7] drm/i915/gvt: replace IS_GEN and friends with
 GRAPHICS_VER
