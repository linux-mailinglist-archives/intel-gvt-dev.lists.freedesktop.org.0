...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 2ED3A1D7150
	for <lists+intel-gvt-dev@lfdr.de>; Mon, 18 May 2020 08:52:58 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id DC8D689C48;
	Mon, 18 May 2020 06:52:56 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 3D7B689C48
 for <intel-gvt-dev@lists.freedesktop.org>;
 Mon, 18 May 2020 06:52:56 +0000 (UTC)
IronPort-SDR: DzT7mNFPCIKYrAQoynD7lrUz4pt4LoGvcvkekShjUk4Fsdf/zFVCrK9ZeaUulumoLxMjpQZm7H
 UOejpia7z3AQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 May 2020 23:52:56 -0700
IronPort-SDR: u5jZrq6Tgfdjoo+nv8La9+Yu/g3AQD87AP+JdjBMwRYNfQOqxJyW6Zd2CpG+sgs3udh4aEbdf4
 vLaTSg566Deg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,406,1583222400"; d="scan'208";a="465470751"
Received: from unknown (HELO coxu-arch-shz.sh.intel.com) ([10.239.160.118])
 by fmsmga005.fm.intel.com with ESMTP; 17 May 2020 23:52:54 -0700
From: Colin Xu <colin.xu@intel.com>
To: intel-gvt-dev@lists.freedesktop.org
Subject: [PATCH 2/2] drm/i915/gvt: Refactor GVT vblank emulator for vGPU
 virtual display
Date: Mon, 18 May 2020 14:52:27 +0800
Message-Id: <20200518065227.178251-3-colin.xu@intel.com>
...
index 881e1317dba4..1ee682ba0682 100644
--- a/drivers/gpu/drm/i915/gvt/display.c
+++ b/drivers/gpu/drm/i915/gvt/display.c
@@ -356,11 +356,27 @@ static void clean_virtual_dp_monitor(struct intel_vgpu *vgpu, int port_num)
 	port->dpcd = NULL;
 }
...
+	struct intel_vgpu_vblank_timer *vblank_timer = &vgpu->vblank_timer;
 	...
 	if (drm_WARN_ON(&i915->drm, resolution >= GVT_EDID_NUM))
 		return -EINVAL;
@@ -387,47 +403,64 @@ static int setup_virtual_dp_monitor(struct intel_vgpu *vgpu, int port_num,
...
@@ -459,7 +492,7 @@ static void emulate_vblank_on_pipe(struct intel_vgpu *vgpu, int pipe)
 	}
 }
...
@@ -469,24 +502,6 @@ static void emulate_vblank(struct intel_vgpu *vgpu)
...
-
  ...
  * @vgpu: a vGPU
@@ -534,6 +549,8 @@ void intel_vgpu_clean_display(struct intel_vgpu *vgpu)
...
index e71acbc48886..e828f625208f 100644
...
@@ -335,13 +336,16 @@ static inline struct intel_gvt *to_gvt(struct drm_i915_private *i915)
 }
...
index 0deb50138efc..1f8aa78893bb 100644
...
index 540017fed908..012e7d46dbab 100644
...
index 1d5ff88078bd..da1494ec947c 100644
--- a/drivers/gpu/drm/i915/gvt/vgpu.c
+++ b/drivers/gpu/drm/i915/gvt/vgpu.c
@@ -299,8 +299,6 @@ void intel_gvt_destroy_vgpu(struct intel_vgpu *vgpu)
 	mutex_unlock(&vgpu->vgpu_lock);
