...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 801401B8D2C
	for <lists+intel-gvt-dev@lfdr.de>; Sun, 26 Apr 2020 09:12:35 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 339B289F27;
	Sun, 26 Apr 2020 07:12:34 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 95E4B89F27
 for <intel-gvt-dev@lists.freedesktop.org>;
 Sun, 26 Apr 2020 07:12:33 +0000 (UTC)
IronPort-SDR: oYXCD4D+Wp44wVM9Va9rUkL2/N1riO0OzlUXVhx4OgYO74NnypOr1YiT9PCl4NWyGM3uCFPkT0
 Ev4mZnQ/pjeg==
...
Received: from orsmga008.jf.intel.com ([10.7.209.65])
 ...
 26 Apr 2020 00:12:32 -0700
IronPort-SDR: mUpARne5wbNlXdAZWyPFDFqN/4Y7DD7S6EmH+/kFenWTiuM5HO9pYLAtXkcWDjRckEHAFIxV1/
 FLneQF+ktC2A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,319,1583222400"; 
 d="asc'?scan'208";a="293162887"
Received: from zhen-hp.sh.intel.com (HELO zhen-hp) ([10.239.160.147])
 by orsmga008.jf.intel.com with ESMTP; 26 Apr 2020 00:12:31 -0700
Date: Sun, 26 Apr 2020 14:58:23 +0800
From: Zhenyu Wang <zhenyuw@linux.intel.com>
To: Yan Zhao <yan.y.zhao@intel.com>
Subject: Re: [PATCH v2 2/2] drm/i915/gvt: Support PPGTT table load command
Message-ID: <20200426065823.GC18545@zhen-hp.sh.intel.com>
...
MIME-Version: 1.0
In-Reply-To: <20200426052803.GD12879@joy-OptiPlex-7040>
...
Content-Type: multipart/mixed; boundary="===============0213388851=="
...
> > @@ -882,6 +882,81 @@ static int mocs_cmd_reg_handler(struct parser_exec=
_state *s,
> >  	return 0;
> >  }
> > =20
...
> >  {
> > @@ -920,6 +995,10 @@ static int cmd_reg_handler(struct parser_exec_stat=
e *s,
...
> > @@ -1900,6 +1900,7 @@ struct intel_vgpu_mm *intel_vgpu_create_ppgtt_mm(=
...
> > @@ -2812,7 +2812,7 @@ static int init_bdw_mmio_info(struct intel_gvt *g=
vt)
...
> > @@ -647,12 +647,48 @@ static void release_shadow_batch_buffer(struct in=
...
> > @@ -712,6 +748,7 @@ static int prepare_workload(struct intel_vgpu_workl=
oad *workload)
...
> >  }
> > =20
> > @@ -821,6 +858,19 @@ pick_next_workload(struct intel_gvt *gvt, struct i=
...
> > @@ -904,6 +954,14 @@ static void update_guest_context(struct intel_vgpu=
_workload *workload)
> >  	intel_gvt_hypervisor_write_gpa(vgpu, workload->ring_context_gpa +
> >  		RING_CTX_OFF(ring_header.val), &workload->rb_tail, 4);
> > =20
> > +	if (!list_empty(&workload->lri_shadow_mm)) {
> > +		struct intel_vgpu_mm *m =3D list_last_entry(&workload->lri_shadow_mm,
...
> > @@ -1014,6 +1072,7 @@ static void complete_current_workload(struct inte=
l_gvt *gvt, int ring_id)
> > =20
...
> > =20
> > @@ -1410,6 +1469,16 @@ void intel_vgpu_destroy_workload(struct intel_vg=
...
iF0EARECAB0WIQTXuabgHDW6LPt9CICxBBozTXgYJwUCXqUxDwAKCRCxBBozTXgY
J2mPAJ9OuQuQEb+gTEg+wuwSpF68LmIt5gCcDx6SXcHBfdnZHBgJts2EQ22oulE=
=ov77
-----END PGP SIGNATURE-----
