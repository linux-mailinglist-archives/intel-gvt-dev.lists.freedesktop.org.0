...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EF272E11E2
	for <lists+intel-gvt-dev@lfdr.de>; Wed, 23 Dec 2020 03:18:43 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 4BEEE6E8B2;
	Wed, 23 Dec 2020 02:18:42 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by gabe.freedesktop.org (Postfix) with ESMTPS id DAD1D6E8B2
 for <intel-gvt-dev@lists.freedesktop.org>;
 Wed, 23 Dec 2020 02:18:41 +0000 (UTC)
IronPort-SDR: imc79MlzyLw4Lg/gG2YEZ2vdRGv7zkl9WwRTzIQ42PAc/nnZHZDtCyWUgZA3lVaPrmtT3lbeBu
 8rLVRHoILnTw==
X-IronPort-AV: E=McAfee;i="6000,8403,9843"; a="176097086"
X-IronPort-AV: E=Sophos;i="5.78,440,1599548400"; d="scan'208";a="176097086"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2020 18:18:40 -0800
IronPort-SDR: wNn2vcK1nFQ5KxJizxUdME0QXd4t1f1yhZaB5wW9C2H64gLhrcersYETweqty9i9uRP3YCZbe2
 9qmdYxSHA2SQ==
X-IronPort-AV: E=Sophos;i="5.78,440,1599548400"; d="scan'208";a="564909113"
Received: from yzhao56-desk.sh.intel.com ([10.239.13.16])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2020 18:18:39 -0800
From: Yan Zhao <yan.y.zhao@intel.com>
To: intel-gvt-dev@lists.freedesktop.org,
	zhenyuw@linux.intel.com
Subject: [PATCH v4 02/11] drm/i915/gvt: scan VM ctx pages
Date: Wed, 23 Dec 2020 10:05:56 +0800
Message-Id: <20201223020556.10791-1-yan.y.zhao@intel.com>
...
index 941bf484a3aa..ba642f7e3bdb 100644
--- a/drivers/gpu/drm/i915/gvt/cmd_parser.c
+++ b/drivers/gpu/drm/i915/gvt/cmd_parser.c
@@ -3191,6 +3191,58 @@ void intel_gvt_update_reg_whitelist(struct intel_vgpu *vgpu)
 	}
 }
