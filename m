...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AFA5720182
	for <lists+intel-gvt-dev@lfdr.de>; Fri,  2 Jun 2023 14:17:06 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 0A16910E691;
...
Subject: [PATCH v12 06/24] vfio: Pass struct vfio_device_file * to
