...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 19AA41C6D65
	for <lists+intel-gvt-dev@lfdr.de>; Wed,  6 May 2020 11:43:25 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A3F266E21F;
	Wed,  6 May 2020 09:43:23 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 053E06E21F
 for <intel-gvt-dev@lists.freedesktop.org>;
 Wed,  6 May 2020 09:43:21 +0000 (UTC)
IronPort-SDR: zG2quyeumnBRTkVPRIekhJKpippRlwXD0nczsDaR2Lg/lbXyY/D5w43aPpwctkEItV+7m4rGSk
 i4ICSbkNU10Q==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 06 May 2020 02:43:21 -0700
IronPort-SDR: PSQZr6w8mgdU8JI7hubSJRpgmwGRcyML1Z8WY1d2lD7U61SLWxcNaLD+Crw78oKMGUMst9Y0vT
 XbaMzey0ypwg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,358,1583222400"; d="scan'208";a="369741023"
Received: from xiaobo4x-mobl1.ccr.corp.intel.com (HELO
 dell-xps.ccr.corp.intel.com) ([10.254.214.128])
 by fmsmga001.fm.intel.com with ESMTP; 06 May 2020 02:43:20 -0700
From: Zhenyu Wang <zhenyuw@linux.intel.com>
To: intel-gvt-dev@lists.freedesktop.org
Subject: [PATCH v3 2/2] drm/i915/gvt: Support PPGTT table load command
Date: Wed,  6 May 2020 17:43:18 +0800
Message-Id: <20200506094318.105604-2-zhenyuw@linux.intel.com>
...
Cc: Yan Zhao <yan.y.zhao@intel.com>, Tina Zhang <tina.zhang@intel.com>
...
index 6e59c7d61397..9c3558489d17 100644
--- a/drivers/gpu/drm/i915/gvt/scheduler.c
+++ b/drivers/gpu/drm/i915/gvt/scheduler.c
@@ -646,12 +646,48 @@ static void release_shadow_batch_buffer(struct intel_vgpu_workload *workload)
 	}
 }
...
@@ -711,6 +747,7 @@ static int prepare_workload(struct intel_vgpu_workload *workload)
...
@@ -820,6 +857,37 @@ pick_next_workload(struct intel_gvt *gvt, struct intel_engine_cs *engine)
 	return workload;
 }
...
@@ -905,6 +973,15 @@ static void update_guest_context(struct intel_vgpu_workload *workload)
...
@@ -1013,6 +1090,7 @@ static void complete_current_workload(struct intel_gvt *gvt, int ring_id)
...
@@ -1409,6 +1487,16 @@ void intel_vgpu_destroy_workload(struct intel_vgpu_workload *workload)
 	release_shadow_batch_buffer(workload);
...
@@ -1427,6 +1515,7 @@ alloc_workload(struct intel_vgpu *vgpu)
