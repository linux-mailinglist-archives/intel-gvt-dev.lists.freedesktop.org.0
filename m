...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id D51AF5F1AB
	for <lists+intel-gvt-dev@lfdr.de>; Thu,  4 Jul 2019 05:01:09 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 7EE176E243;
	Thu,  4 Jul 2019 03:01:08 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by gabe.freedesktop.org (Postfix) with ESMTPS id AC2CD6E243
 for <intel-gvt-dev@lists.freedesktop.org>;
 Thu,  4 Jul 2019 03:01:07 +0000 (UTC)
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga103.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 03 Jul 2019 20:01:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.63,449,1557212400"; 
 d="asc'?scan'208";a="154933241"
Received: from zhen-hp.sh.intel.com (HELO zhen-hp) ([10.239.13.116])
 by orsmga007.jf.intel.com with ESMTP; 03 Jul 2019 20:01:06 -0700
Date: Thu, 4 Jul 2019 10:58:27 +0800
From: Zhenyu Wang <zhenyuw@linux.intel.com>
To: "Xu, Colin" <colin.xu@intel.com>
Subject: Re: [PATCH] drm/i915/gvt: Do not check shadowed when adding ppgtt to
 GVT GEM context
Message-ID: <20190704025827.GT9684@zhen-hp.sh.intel.com>
...
Content-Type: multipart/mixed; boundary="===============1940011507=="
...
Content-Type: multipart/signed; micalg=pgp-sha1;
	protocol="application/pgp-signature"; boundary="o1/0/m+AY5DY8EuM"
...
On 2019.07.04 10:55:15 +0800, Zhenyu Wang wrote:
...
> >=20
> > In work thread before each submission, a shadow_mm is set to shadowed i=
n:
> > shadow_ppgtt_mm()
> > <-intel_vgpu_pin_mm()
> > <-prepare_workload()
...
> > it will reuse the old one. Since shadow_mm is reused, checking of shado=
wed
...
>=20
> Thanks for tracing this! I think this is a side effect from 1e18d5e6731d6=
74fee0bb4b66f5ea61e504452a3,
> which I moved this setting out of scan function.
>=20
> One potential issue with this is shadow_pdps at this time might not have =
valid value yet,
> how about we move shadow ctx ppgtt setting after we really prepared mm fo=
r workload and
> before i915 submission? As this setting now is mostly to please i915, we =
have already set
...
> > @@ -371,7 +371,7 @@ static int set_context_ppgtt_from_shadow(struct int=
...
As 5.2 will be close to release, I think this fix might not be able to catc=
h up,
pls make sure to cc stable kernel.
...
iF0EARECAB0WIQTXuabgHDW6LPt9CICxBBozTXgYJwUCXR1rUwAKCRCxBBozTXgY
JwGcAKCLeDhljC6wn6j2BFXXk74x1HGcygCcDD30S05Ey4RJrWubrb9fdZlnHI4=
=REr6
-----END PGP SIGNATURE-----
