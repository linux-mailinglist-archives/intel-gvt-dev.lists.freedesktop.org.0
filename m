...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id E1A712E11B6
	for <lists+intel-gvt-dev@lfdr.de>; Wed, 23 Dec 2020 03:17:10 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id C481D6E89C;
	Wed, 23 Dec 2020 02:17:08 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 5EA256E89F
 for <intel-gvt-dev@lists.freedesktop.org>;
 Wed, 23 Dec 2020 02:17:07 +0000 (UTC)
IronPort-SDR: 7LlrwEbupqJYIv6GJ4txJnCRPRwCLBILAueK9+MKasnQACon6NIbvAWADUAErosJCNJXsjh+l+
 KGmKR0WGYIzg==
X-IronPort-AV: E=McAfee;i="6000,8403,9843"; a="172439571"
X-IronPort-AV: E=Sophos;i="5.78,440,1599548400"; d="scan'208";a="172439571"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2020 18:17:07 -0800
IronPort-SDR: Pvg4csGutGkhB/D3CM1v+rqGM6b+NZfcbN0rbwa3O/5J3DLfN7mSXwIU0yNbGn1dyPeSwMLWlf
 a6vA8HQQff4w==
X-IronPort-AV: E=Sophos;i="5.78,440,1599548400"; d="scan'208";a="564908823"
Received: from yzhao56-desk.sh.intel.com ([10.239.13.16])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 22 Dec 2020 18:17:05 -0800
From: Yan Zhao <yan.y.zhao@intel.com>
To: intel-gvt-dev@lists.freedesktop.org,
	zhenyuw@linux.intel.com
Subject: [PATCH v4 01/11] drm/i915/gvt: parse init context to update cmd
 accessible reg whitelist
Date: Wed, 23 Dec 2020 10:04:21 +0800
Message-Id: <20201223020421.10724-1-yan.y.zhao@intel.com>
...
---
 drivers/gpu/drm/i915/gvt/cmd_parser.c | 141 +++++++++++++++++++++++++-
...
index 16b582cb97ed..941bf484a3aa 100644
...
@@ -3056,6 +3078,119 @@ int intel_gvt_scan_and_shadow_wa_ctx(struct intel_shadow_wa_ctx *wa_ctx)
 	return 0;
 }
