...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id EPnDLXlHrWkl0wEAu9opvQ
	(envelope-from <intel-gvt-dev-bounces@lists.freedesktop.org>)
	for <lists+intel-gvt-dev@lfdr.de>; Sun, 08 Mar 2026 10:55:05 +0100
X-Original-To: lists+intel-gvt-dev@lfdr.de
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 8277022F3F8
	for <lists+intel-gvt-dev@lfdr.de>; Sun, 08 Mar 2026 10:55:04 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id EBABA10E0F5;
...
X-Spamd-Result: default: False [1.99 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[peterz@infradead.org,intel-gvt-dev-bounces@lists.freedesktop.org];
	FROM_HAS_DN(0.00)[];
