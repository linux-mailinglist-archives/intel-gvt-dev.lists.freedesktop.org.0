...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 86A601B8D74
	for <lists+intel-gvt-dev@lfdr.de>; Sun, 26 Apr 2020 09:31:50 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 327FC6E22D;
	Sun, 26 Apr 2020 07:31:48 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 84D0A6E22D
 for <intel-gvt-dev@lists.freedesktop.org>;
 Sun, 26 Apr 2020 07:31:46 +0000 (UTC)
IronPort-SDR: bM+XCi5a/IHUalbsojqCNsDfYI8rVs2snfrrWg6J/M1kubmRSYZqIHJHye94WuGwK59CqDxVYQ
 ix6h82hrVnkQ==
...
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 ...
 26 Apr 2020 00:31:46 -0700
IronPort-SDR: wcrIIIZgjXaddTPiMu+ejRYuoetEhiMoFgKendhceAlOKeMlZWTwFk0GO4FwpSWq5qe5F0yCL/
 cdNjG7qfnzBg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,319,1583222400"; 
 d="asc'?scan'208";a="281345698"
Received: from zhen-hp.sh.intel.com (HELO zhen-hp) ([10.239.160.147])
 by fmsmga004.fm.intel.com with ESMTP; 26 Apr 2020 00:31:44 -0700
Date: Sun, 26 Apr 2020 15:17:36 +0800
From: Zhenyu Wang <zhenyuw@linux.intel.com>
To: "Zhao, Yan Y" <yan.y.zhao@intel.com>
Subject: Re: [PATCH v2 2/2] drm/i915/gvt: Support PPGTT table load command
Message-ID: <20200426071736.GD18545@zhen-hp.sh.intel.com>
...
MIME-Version: 1.0
In-Reply-To: <20200426065823.GC18545@zhen-hp.sh.intel.com>
...
Content-Type: multipart/mixed; boundary="===============1047491639=="
...
> > > @@ -882,6 +882,81 @@ static int mocs_cmd_reg_handler(struct parser_ex=
ec_state *s,
> > >  	return 0;
> > >  }
> > > =20
...
> > >  {
> > > @@ -920,6 +995,10 @@ static int cmd_reg_handler(struct parser_exec_st=
ate *s,
...
> > > @@ -1900,6 +1900,7 @@ struct intel_vgpu_mm *intel_vgpu_create_ppgtt_m=
m(struct intel_vgpu *vgpu,
> > > =20
...
> > > @@ -2812,7 +2812,7 @@ static int init_bdw_mmio_info(struct intel_gvt =
*gvt)
> > >  	MMIO_D(GAMTARBMODE, D_BDW_PLUS);
> > > =20
> > >  #define RING_REG(base) _MMIO((base) + 0x270)
> > > -	MMIO_RING_F(RING_REG, 32, 0, 0, 0, D_BDW_PLUS, NULL, NULL);
> > > +	MMIO_RING_F(RING_REG, 32, F_CMD_ACCESS, 0, 0, D_BDW_PLUS, NULL, NUL=
L);
> > >  #undef RING_REG
> > > =20
...
> > > @@ -647,12 +647,48 @@ static void release_shadow_batch_buffer(struct =
...
> > > @@ -712,6 +748,7 @@ static int prepare_workload(struct intel_vgpu_wor=
kload *workload)
...
> > >  }
> > > =20
> > > @@ -821,6 +858,19 @@ pick_next_workload(struct intel_gvt *gvt, struct=
...
> > > +}
> > > +
> > >  static void update_guest_context(struct intel_vgpu_workload *workloa=
d)
> > >  {
> > >  	struct i915_request *rq =3D workload->req;
> > > @@ -904,6 +954,14 @@ static void update_guest_context(struct intel_vg=
pu_workload *workload)
> > >  	intel_gvt_hypervisor_write_gpa(vgpu, workload->ring_context_gpa +
> > >  		RING_CTX_OFF(ring_header.val), &workload->rb_tail, 4);
> > > =20
> > > +	if (!list_empty(&workload->lri_shadow_mm)) {
> > > +		struct intel_vgpu_mm *m =3D list_last_entry(&workload->lri_shadow_=
mm,
...
> > > @@ -1014,6 +1072,7 @@ static void complete_current_workload(struct in=
tel_gvt *gvt, int ring_id)
> > > =20
...
> > > =20
> > > @@ -1410,6 +1469,16 @@ void intel_vgpu_destroy_workload(struct intel_=
...
> > > diff --git a/drivers/gpu/drm/i915/gvt/scheduler.h b/drivers/gpu/drm/i=
915/gvt/scheduler.h
...
iF0EARECAB0WIQTXuabgHDW6LPt9CICxBBozTXgYJwUCXqU1kAAKCRCxBBozTXgY
JxpIAJ9YQT0gvhom4FU3JTXqkmNzG+MQvgCaA8zJ+7x/1hUmxNtRKUpCEHcCNwo=
=aGd4
-----END PGP SIGNATURE-----
