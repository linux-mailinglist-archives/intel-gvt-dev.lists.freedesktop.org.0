...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 84C734FBE8C
	for <lists+intel-gvt-dev@lfdr.de>; Mon, 11 Apr 2022 16:14:43 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 3221F10EA81;
...
Subject: [PATCH 10/34] drm/i915/gvt: merge struct kvmgt_vdev into struct
 intel_vgpu
