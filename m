...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id A720F74E4B7
	for <lists+intel-gvt-dev@lfdr.de>; Tue, 11 Jul 2023 04:59:45 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 28A1C10E2F7;
...
Subject: [PATCH v14 06/26] vfio: Pass struct vfio_device_file * to
