...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [131.252.210.177])
	by mail.lfdr.de (Postfix) with ESMTPS id 0FD561CBCF1
	for <lists+intel-gvt-dev@lfdr.de>; Sat,  9 May 2020 05:23:22 +0200 (CEST)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id 563EF6E2D3;
	Sat,  9 May 2020 03:23:20 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id 1491C6E2D3
 for <intel-gvt-dev@lists.freedesktop.org>;
 Sat,  9 May 2020 03:23:19 +0000 (UTC)
IronPort-SDR: JZLn40aDvdHmJzWsPGaFjkpHjooFwspNyaDD9WcFmo7KrTc1r6XMA/ZLrTryFq5WnWPfjBLXKf
 HtgEKeDHoWRg==
...
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 ...
 08 May 2020 20:23:18 -0700
IronPort-SDR: NjyguQi6R0aH/fOJiV8TDUZ3D5qjrKp2351Vll+3gWgGkgYd4lgG3a+cT9BhuZ3omxh2dt3eFh
 dXKBE6BVVnfg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,370,1583222400"; 
 d="asc'?scan'208";a="249938786"
Received: from zhen-hp.sh.intel.com (HELO zhen-hp) ([10.239.160.147])
 by orsmga007.jf.intel.com with ESMTP; 08 May 2020 20:23:17 -0700
Date: Sat, 9 May 2020 11:08:40 +0800
From: Zhenyu Wang <zhenyuw@linux.intel.com>
To: Xiong Zhang <xiong.y.zhang@intel.com>
Subject: Re: [PATCH] drm/i915/gvt: Fix kernel oops for 3-level ppgtt guest
Message-ID: <20200509030840.GK18545@zhen-hp.sh.intel.com>
...
MIME-Version: 1.0
In-Reply-To: <20200508115018.GE18545@zhen-hp.sh.intel.com>
...
Content-Type: multipart/mixed; boundary="===============1525575546=="
...
Content-Type: multipart/signed; micalg=pgp-sha1;
	protocol="application/pgp-signature"; boundary="iNKvvK4J48bNrWSb"
...
> > >=20
> > > As i915 won't allocate extra PDP for current default PML4 table, so f=
or 3-level
> > > ppgtt guest, we would hit kernel pointer access failure on extra PDP =
pointers.
> > > So this trys to bypass that now.
> > > It won't impact real shadow PPGTT setup, so guest context still works.
> > >=20
> > > This is verified on 4.15 guest kernel with i915.enable_ppgtt=3D1 to f=
orce on old
...
> > > +			if (!pd)
> > > +				break;
> > [Zhang, Xiong Y]  does it  exist in older kernel only ?  current stagin=
g code allocate 4 pdp for non 4-level table.
>=20
> But in all current case we'll only allocate for pml4 as it checks hw info.
>=20
> > I915_context_ppgtt_root_restore()  have the same issue, it should be mo=
dified also.
>=20
...
iF0EARECAB0WIQTXuabgHDW6LPt9CICxBBozTXgYJwUCXrYeuAAKCRCxBBozTXgY
J/VRAKCduFjL3uOgkN/GQpYxKxg9xOOvAgCeLdg2o0eMVHQV6qlP/S0RlHqy6PA=
=IX6H
-----END PGP SIGNATURE-----
