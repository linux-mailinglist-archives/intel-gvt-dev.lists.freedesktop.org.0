...
Received: from gabe.freedesktop.org (gabe.freedesktop.org [IPv6:2610:10:20:722:a800:ff:fe36:1795])
	by mail.lfdr.de (Postfix) with ESMTPS id 033DB2D39EB
	for <lists+intel-gvt-dev@lfdr.de>; Wed,  9 Dec 2020 05:53:14 +0100 (CET)
Received: from gabe.freedesktop.org (localhost [127.0.0.1])
	by gabe.freedesktop.org (Postfix) with ESMTP id A8B1D6E0ED;
	Wed,  9 Dec 2020 04:53:12 +0000 (UTC)
X-Original-To: intel-gvt-dev@lists.freedesktop.org
Delivered-To: intel-gvt-dev@lists.freedesktop.org
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 by gabe.freedesktop.org (Postfix) with ESMTPS id E5DEF6E0E9
 for <intel-gvt-dev@lists.freedesktop.org>;
 Wed,  9 Dec 2020 04:53:10 +0000 (UTC)
IronPort-SDR: nFby45XUwJJTMoDrWybud7/y8AiwoZZv/X2PvQtrOk/00Xt1yBIULSncMXyu/hwqhy2kRaMAAq
 6nM8ap6Jok5w==
X-IronPort-AV: E=McAfee;i="6000,8403,9829"; a="258726968"
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="258726968"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2020 20:53:10 -0800
IronPort-SDR: JE93aaNauuQOIAoanoWZMkA3RjCaztNqsBiY750v+1uBXtOmmEmn+1jpJyVB9H1lMlI6cx4V1f
 cYh1/GDAbEBw==
X-IronPort-AV: E=Sophos;i="5.78,404,1599548400"; d="scan'208";a="542263837"
Received: from yzhao56-desk.sh.intel.com ([10.239.13.16])
 by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 08 Dec 2020 20:53:08 -0800
From: Yan Zhao <yan.y.zhao@intel.com>
To: intel-gvt-dev@lists.freedesktop.org,
	zhenyuw@linux.intel.com
Subject: [PATCH v3 01/11] drm/i915/gvt: parse init context to update cmd
 accessible reg whitelist
Date: Wed,  9 Dec 2020 12:40:29 +0800
Message-Id: <20201209044029.2525-1-yan.y.zhao@intel.com>
